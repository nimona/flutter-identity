package io.nimona.gohashmobile
...
class IdentityMobilePlugin() : MethodCallHandler {
    companion object {
        @JvmStatic
        fun registerWith(registrar: Registrar) {
            val channel = MethodChannel(registrar.messenger(), "identity_mobile")
            channel.setMethodCallHandler(IdentityMobilePlugin())
        }
    }
